...
class CrmTeam(models.Model):
    ...
    def _auto_archieve(self):
        ...
        for auto_archieve in self.stage_auto_archieve_ids:
            ...
            date_day_limit_openchatter = date_day_limit_openchatter.astimezone(tz.gettz('UTC')).replace(hour=0, minute=0, second=0, microsecond=0).astimezone(tz.gettz('Asia/Jakarta'))
